 ...
 */
class WithdrawLists extends BaseAdminDataLists implements ListsSearchInterface, ListsSortInterface,ListsExcelInterface
{
 ...
 /**
    ...
    {
        return Withdraw::where($this->searchWhere)->where($this->queryWhere())->count();
    }
