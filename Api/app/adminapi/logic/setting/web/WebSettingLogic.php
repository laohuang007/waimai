...
class WebSettingLogic extends BaseLogic
{
    ...
    public static function setWebsiteInfo(array $params)
    {
        ...
        ConfigService::set('website', 'shop_url', $params['shop_url']);
        ConfigService::set('website', 'shop_text_pay', $params['shop_text_pay']);
        ConfigService::set('website', 'shop_text_submit', $params['shop_text_submit']);
        ConfigService::set('website', 'shop_text_nopay', $params['shop_text_nopay']);
        ConfigService::set('website', 'shop_text_paynot', $params['shop_text_paynot']);
        ConfigService::set('website', 'shop_text_payin', $params['shop_text_payin']);
        ConfigService::set('website', 'shop_text_payfail', $params['shop_text_payfail']);
        ConfigService::set('website', 'shop_text_paysuccess', $params['shop_text_paysuccess']);
        ConfigService::set('website', 'shop_color', $params['shop_color']);
