    ...
    <div class="orders-lists">
        <el-card class="!border-none" shadow="never">
            <el-form ref="formRef" class="mb-[-16px]" :model="queryParams" :inline="true">
                ...
                <el-form-item class="w-[280px]" label="钱包地址">
                    <el-input
                        v-model="queryParams.wallet_address"
                        placeholder="钱包地址"
                        clearable
                    />
                </el-form-item>
        ...
        <el-card class="!border-none mt-4" shadow="never">
            <div>
                <div class="float-right" v-perms="['waimai.withdraw/add']">
            ...
            <el-table size="large"  v-loading="pager.loading" :data="pager.lists">
                ...
                <el-table-column label="提现金额" prop="order_amount" min-width="100" />
                ...
                <el-table-column label="操作" width="230" fixed="right">
                    <template #default="{ row }">
                        <el-button
                            v-perms="['waimai.withdraw/updateStatus']"
                            type="primary"
                            link
                        ...
                        <el-button
                            v-perms="['waimai.withdraw/delete']"
                            type="danger"
                            link
        ...
        <el-dialog v-model="showLink" :show-close="false" width="500">
            <template #header="{ close, titleId, titleClass }">
            <div class="my-header">
                <h4 :id="titleId" :class="titleClass">钱包地址
...
import {  withdrawDelete,withdrawLists, withdrawUpdateStatus } from '@/api/waimai/orders'
...
const handleLink=(row:any)=>{
    linkUrl.value=row.wallet_address;
    showLink.value=true
}
...
const priceSb = async ()=>{
    const res=await  withdrawUpdateStatus(state.upData)
